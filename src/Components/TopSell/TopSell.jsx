...
const TopSell = () => {
  ...
  <div className="card-body">
    <h2 className="text-[12px] lg:text-xl font-semibold ">Samsung Galaxy Tab S8</h2>
    <div className="flex justify-between items-center">
  ...
  <div className="card-body">
    <h2 className="text-[12px] lg:text-xl font-semibold ">Google Pixel 8</h2>
    <div className="flex justify-between items-center">
  ...
  <div className="card-body">
    <h2 className="text-[12px] lg:text-xl font-semibold ">Samsung Galaxy S23 Ultra</h2>
    <div className="flex justify-between items-center">
        <p className="text-[13px]  lg:text-[18px] text-black font-medium ">Price : $1110</p>
  ...
  <div className="card-body">
    <h2 className="text-[12px] lg:text-xl font-semibold ">Sony Headphones</h2>
    <div className="flex justify-between items-center">
